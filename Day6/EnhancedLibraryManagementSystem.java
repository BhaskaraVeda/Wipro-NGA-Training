...
The system manages different types of items in the library, such as books, DVDs, and magazines.  Each item has common attributes like title, author/creator, a unique identifier, and a status indicating whether it is checked out or available.

Boiler plate code implementation of base class : \
LibraryItem and its subclasses : Book ,DVD and Magazine, and a generic class Library
representing the library are given. 

The enhanced system introduces the ability to check out and return items. 
Exceptions are used to handle scenarios where an item is already checked out or not checked out
when attempting to return it.

The code starts with the main class EnhancedLibraryManagementSystemwhich contains the 
main method to execute the Library Management System. 

A description of each class is provided below, along with the task that you need to complete 
and finish.
...
Implement the Constructor : define a parameterized constructor with 4 arguments: 
int itemId, String title, String author, int numPages.
...
Constructor Implementation: (Complete the code)
Implement the constructor. : define a parameterized constructor with 4 arguments 
int itemId, String title, String director, int duration.
...
Constructor Implementation: (Complete the code) 
Implement the constructor. : define a parameterized constructor with 4 arguments:
int itemId, String title, String publisher, int issueNumber.
...
Custom exception for handling cases where an item is already checked out. 
(It should display in the below given format) 
...
Custom exception for handling cases where an item is not checked out when attempting to return it.
(It should display in the below given format)
...
class Library<T extends LibraryItem> {
    // FIX APPLIED: Protected access to resolve previous compilation error
