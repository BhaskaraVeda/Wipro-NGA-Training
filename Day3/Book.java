...
Create a Java class named Book to represent a book. 
...
Methods: 
A method named displayInfo that prints the details of the book (title, author, and year).


Application: 
In the main method, create two instances of the Book class using both the default constructor 
and the parameterized constructor.

Call the displayInfo method on each instance to display the details of the books. 
Your goal is to implement the Book class with appropriate constructors and methods as described.
 ...
 */
 ...
 public class Book {
    ...
    // Main method, moved into the Book class so the testing environment can execute it
