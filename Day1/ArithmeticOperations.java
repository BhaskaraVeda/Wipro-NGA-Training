...
operations on them using the arithmetic operators (sum, difference, product, quotient, remainder)
in Java.
...
public class ArithmeticOperations {
    public static void main(String[] args) {
        ...
        if (num2 != 0) {
            ...
            System.out.println("Remainder: Cannot calculate remainder for zero divisor.");
        }
