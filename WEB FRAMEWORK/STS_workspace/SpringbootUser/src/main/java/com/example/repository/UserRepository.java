...
import com.example.model.User;
	...
	@Autowired
		...
		//6. from service class it will come here in repository to save into the database and
		// and return the response back to service and then service will give response back t
